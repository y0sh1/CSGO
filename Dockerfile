...
cd /home/steam/csgo-dedicated/csgo && \ 
    curl https://raw.githubusercontent.com/y0sh1/CSGO/master/etc/cfg.tar.gz -o cfg.tar.gz && \
    tar -xf cfg.tar.gz && rm cfg.tar.gz

ENV SRCDS_FPSMAX=300 SRCDS_TICKRATE=128 SRCDS_PORT=27015 SRCDS_TV_PORT=27020 SRCDS_MAXPLAYERS=14 SRCDS_TOKEN=0 SRCDS_RCONPW="changeme"
